...
configs_fedCAM = {
    ...
    "nb_rounds": 30,  # Maximum number of communication rounds for federated learning
    ...
    "cvae_input_dim":512, #28928,# Dimension of the input for CVAE and the size of the activation maps ("activation_size")
