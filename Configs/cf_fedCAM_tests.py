...
configs_fedCAM = {
    ...
    # Clients Settings
    "num_epochs": 1,#2,#1,  # Number of epochs for training
    "batch_size": 128,  # Batch size for training
    "lr": 0.01, #0.01,#0.01#5e-3, #3e-4, #5e-4, # Learning rate #3e-4
    ...
    "cvae_input_dim": 28928,#10368,#28928,  # Dimension of the input for CVAE and the size of the activation maps ("activation_size")
    ...
    "cvae_nb_ep": 20,  # Number of epochs for training a CVAE model
    ...
    "size_trigger": 500,  # Trigger size for defense mechanism
    "size_test": 500,
